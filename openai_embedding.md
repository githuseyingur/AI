...
#### Chat Completion
* kullanıcı sorusunun <u>threshold değeri küçükse</u> : (embedding değerine göre veri setindeki değerlere yakın değilse) > <b>chat completions</b>
* kullanıcı sorusunun <u>threshold değeri büyükse</u> : <b>embeddings.csv'deki cevap</b>
```python
import pandas as pd
from sklearn.metrics.pairwise import cosine_similarity
